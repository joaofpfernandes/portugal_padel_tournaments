...
Um site gratuito que reúne toda a informação competitiva do padel em Portugal num só lugar — calendário, rankings, pontos e perfis de jogadores.
...
- **Filtra** por mês, categoria (Absolutos, Veteranos, Jovens) ou apenas eventos FIP
- Cada torneio mostra datas, localização, organização, nível, pontos/prémios e links diretos para inscrição ou resultados
...
- Consulta quantos pontos faltam para subir de nível
- **Análise de par** — escolhe um segundo jogador e descobre a soma de pontos do par e os níveis em que podem jogar juntos
...
- **Filtra** por nível, escalão ou clube
- Vê a variação de posição face à semana anterior
- Acede diretamente ao perfil TiePadel de cada jogador

---

Dados atualizados automaticamente a partir das fontes oficiais FPP e FIP.
